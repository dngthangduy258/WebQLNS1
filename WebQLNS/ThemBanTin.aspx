<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLayout.Master" AutoEventWireup="true" CodeBehind="ThemBanTin.aspx.cs" Inherits="WebQLNS.ThemBanTin" %>
    ...
    <form>
        <div class="container">
            ...
            <div class="row mb-2">
                ...
                <asp:TextBox CssClass="row col-10" type="date" ID="txtNgayDang" runat="server"></asp:TextBox>
            </div>
            <div class="row mb-2">
